    ...
    >
      <CardContent className={styles["note-info"]}>
        <div className={styles["note-info__dates"]}>
          <Typography className={styles["note-info__updated__date"]}>
            {formatToReadbleDate(note.updatedAt)}
          </Typography>
        </div>
        <Typography
          className={styles["note-info__title"]}
          variant="h6"
          gutterBottom
        >
          {note.title}
        ...
        <Typography
          className={styles["note-info__description"]}
