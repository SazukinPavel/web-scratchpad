...
export default function AddNote() {
    ...
    const [addNoteMutation, {loading: isAddLoading, error: addError}] = useMutation(AddNoteMutation);
    ...
    return (
        <Container component="main" maxWidth="xs">
            <NoteForm title="Add new note" onSubmit={handleSubmit} btn={{isLoading: isAddLoading, title: 'Add'}}/>
        </Container>
    );
}